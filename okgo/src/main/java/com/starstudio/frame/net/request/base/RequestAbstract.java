...
import com.starstudio.frame.net.adapter.OnCall;
...
public abstract class RequestAbstract<T, R extends RequestAbstract> implements Serializable {
    ...
    protected transient OnCall<T> OnCall;
    protected transient OnCallback<T> OnCallback;
    protected transient OnConverter<T> OnConverter;
    ...
    @SuppressWarnings("unchecked")
    public R converter(OnConverter<T> OnConverter) {
    ...
    public void setOnCallback(OnCallback<T> onCallback) {
        this.OnCallback = onCallback;
    }

    public OnConverter<T> getOnConverter() {
